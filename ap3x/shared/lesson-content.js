/* AutoSkill OS™ — Training Module Content
   ...
   Imported/inlined by patient-demo.html and patient-app.js (filenames preserved for deployment).
...
const LESSON_CONTENT = {
  ...
  m1l1: {
    ...
    summary: 'Progress is not always a straight line. Some days may feel easier, while others may feel more difficult. This lesson helps you understand training progress as a process of learning, noticing patterns, building support, and taking small steps that help you feel safer and more able to cope.',
    learningGoals: [
      'Understand that skill development can look different for every person.',
    ...
    sections: [
      { heading: 'Progress is personal', body: 'Workplace competency development does not mean feeling perfect all the time. It can mean understanding yourself better, recognising what affects your performance, learning support strategies, and feeling more able to ask for help when needed. Everyone\'s training progress looks different.' },
      ...
      { heading: 'Small steps count', body: 'Small actions can build competency. This might include completing a check-in, noticing a trigger, using a focus break, writing down a thought, contacting someone supportive, or attending a training session. These steps can build confidence over time.' },
    ...
    supervisorNote: 'Review the employee\'s definition of progress. It may reveal expectations, pressure points, or opportunities for realistic goal-setting.',
  ...
  m1l2: {
    ...
    estimatedTime: '8–10 minutes',
    summary: 'Confidence, energy, and focus can affect thoughts, feelings, body sensations, and behaviour. This lesson helps you understand how these experiences can show up and why tracking them may help you and your supervisor recognise useful patterns.',
    learningGoals: [
      'Understand how confidence, energy, and focus affect training.',
      'Notice how emotional experiences can affect the body.',
      'Learn why tracking training readiness and workload can be useful.',
      'Build confidence in describing your experience.'
    ],
    sections: [
      { heading: 'What training readiness means', body: 'Training readiness is your current capacity to take in new information and perform tasks well. It can include feeling focused, calm, motivated, tired, or unsettled. Readiness can change throughout the day and may be affected by rest, workload, relationships, and life events.' },
      { heading: 'What pressure can feel like', body: 'Work pressure can include worry, hesitation, tension, or feeling rushed. These are normal responses to unfamiliar tasks. Pressure is not a personal failure — it is a signal that more practice or support may help.' },
      { heading: 'What workload pressure can feel like', body: 'Stress often appears when demands feel greater than your current capacity. It can affect concentration, patience, sleep, energy, motivation, and physical tension. Stress can build slowly, so noticing early signs is important.' },
      { heading: 'Why rating helps', body: 'Rating readiness, confidence, or workload pressure from 1–10 can make invisible experiences easier to track. A number is not the whole story, but it can help show patterns over time.' },
    ...
    reflectionPrompt: 'How does work pressure or low confidence usually show up for you on the job?',
    learnerTask: 'Choose one word that describes how you feel today. Then rate your readiness and energyorkload pressure from 1–10.',
    supervisorNote: 'Look for differences between employee self-ratings and observed performance. These may help guide coaching conversations.',
    platformNote: 'This training module is for learning and reflection only. It does not replace site-specific safety protocols, supervisor guidance, or emergency procedures. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m1l3: {
    ...
    sections: [
      ...
      { heading: 'Building awareness', body: 'Over time, trigger tracking can help you and your supervisor identify patterns. This can support planning, support strategies, boundaries, and safer responses.' }
    ],
  ...
  m1l4: {
    ...
    estimatedTime: '8–10 minutes',
    summary: 'Tracking can help you notice patterns in readiness, stress, sleep, energy, support strategies, and support needs. This lesson explains how to track safely without becoming overwhelmed or overly self-critical.',
    learningGoals: [
    ...
    sections: [
      { heading: 'Why patterns matter', body: 'Training progress can feel uneven, but patterns often appear over time. You may notice that workload pressure rises after poor rest, focus drops after long isolation, or support improves after routine, movement, connection, or rest.' },
      { heading: 'What can be tracked', body: 'Useful areas include readiness, confidence, stress, sleep, energy, appetite, concentration, support strategies, social connection, symptoms, triggers, and notes for your supervisor.' },
      ...
      { heading: 'Look for trends, not single days', body: 'One difficult day does not define your progress. Patterns become clearer when you look across several days or weeks. Your supervisor can help interpret what the data might mean.' },
      { heading: 'Keep it simple', body: 'A short check-in is enough. You do not need long explanations every day. Even a readiness score, energy rating, and one sentence can be useful.' }
    ],
    ...
    supervisorNote: 'Encourage employees to use tracking as information, not performance. Watch for perfectionism or pressure around recording data.',
    platformNote: 'This training module is for learning and reflection only. It does not replace site-specific safety protocols, supervisor guidance, or emergency procedures. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m1l5: {
    ...
    estimatedTime: '8–10 minutes',
    summary: 'Asking for support can be difficult, especially when you are used to working independently. This lesson helps you recognise signs that extra support may be needed and how to communicate this clearly.',
    learningGoals: [
  ...
  m2l1: {
    ...
    estimatedTime: '10–12 minutes',
    summary: 'Breathing and grounding techniques can help calm the body when workload pressure or pressure rises. This lesson introduces simple tools that can be practised gently and used when helpful.',
    learningGoals: [
    ...
    sections: [
      { heading: 'Why regulation helps', body: 'When the body feels threatened or overwhelmed, it may move into a workload pressure response. Breathing and grounding techniques can help signal safety and bring attention back to the present.' },
      ...
      { heading: 'Practise when ready', body: 'Support skills often work better when practised before a difficult situation arises. Try using them during routine moments so they feel natural when needed.' }
    ],
    ...
    supervisorNote: 'Check whether focus breaks feel safe for the employee. Some patients may prefer grounding over breath focus.',
    platformNote: 'This training module is for learning and reflection only. It does not replace site-specific safety protocols, supervisor guidance, or emergency procedures. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m2l2: {
    ...
    sections: [
      { heading: 'Why routine helps', body: 'Routine can reduce decision pressure and create small anchors in the day. Predictable actions can support sleep, readiness, energy, and emotional regulation.' },
      { heading: 'Start small', body: 'A helpful routine might begin with one or two actions, such as drinking water, opening curtains, taking medication as prescribed, completing a check-in, stepping outside, eating something nourishing, or doing a grounding check.' },
      { heading: 'Make a difficult-day version', body: 'Progress routines should include a low-energy version. For example, if a walk feels too much, sitting near a window may be enough. If journaling feels too much, writing one word may be enough.' },
    ...
    supervisorNote: 'Review whether the employee\'s training routine is realistic. Encourage flexible routines rather than perfectionistic plans.',
    platformNote: 'This training module is for learning and reflection only. It does not replace site-specific safety protocols, supervisor guidance, or emergency procedures. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m2l3: {
    ...
    sections: [
      { heading: 'Thoughts can feel convincing', body: 'When you are stressed, low, or uncertain, thoughts may become more intense. You might notice "what if" thoughts, self-critical thoughts, hopeless thoughts, or pressure-filled thoughts.' },
  ...
  m2l4: {
    ...
    learningGoals: [
      ...
      'Notice how rest affects your focus and task performance.',
      'Learn simple sleep-supportive habits.',
      'Identify one realistic rest goal.'
    ],
    sections: [
      { heading: 'Rest affects performance', body: 'Poor rest can make tasks feel harder, reduce concentration, increase irritability, and make support strategies harder to use. This does not mean you are failing; it means your system may be under strain.' },
    ...
    reflectionPrompt: 'How does your rest usually affect your focus and task performance?',
  ...
  m2l5: {
    ...
    estimatedTime: '10–12 minutes',
    summary: 'A support plan helps you know what to do when things become difficult. This lesson helps you create a simple plan that includes support strategies, supportive people, professional support, and crisis steps.',
    learningGoals: [
      'Understand what a support plan is.',
      'Identify personal warning signs.',
      'Choose support strategies.',
    ...
    sections: [
      ...
      { heading: 'Warning signs', body: 'Warning signs may include withdrawal, poor sleep, racing thoughts, feeling numb, irritability, avoiding responsibilities, increased confidence, low readiness, or feeling unable to cope.' },
      { heading: 'Support actions', body: 'Helpful actions might include taking a short break, reviewing a procedure checklist, stepping away from a complex task, drinking water, writing notes down, using a work routine, or asking a colleague or trainer for help.' },
    ...
    learnerTask: 'Create a simple support plan with three support actions and two people you can ask for help.',
    supervisorNote: 'Review the employee\'s support plan and help make it specific, realistic, and safe.',
    platformNote: 'This training module is for learning and reflection only. It does not replace site-specific safety protocols, supervisor guidance, or emergency procedures. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m3l1: {
    ...
    sections: [
      { heading: 'Progress can be subtle', body: 'Progress may look like noticing a trigger sooner, asking for support, completing a check-in, using a support strategy, attending a training session, resting instead of pushing through, or speaking to yourself more kindly.' },
      { heading: 'Progress is not perfection', body: 'You can be making progress and still have difficult days. Progress does not require constant improvement. It often involves learning how to respond differently when difficulties appear.' },
      { heading: 'Look at evidence', body: 'Use check-ins, lesson completion, progress trends, notes, and support strategy use as evidence. This can help you see change more clearly over time.' },
      { heading: 'Name strengths', body: 'Strengths might include persistence, honesty, courage, awareness, patience, creativity, care for others, or willingness to try. These strengths can support progress.' },
  ...
  m3l2: {
    ...
    supervisorNote: 'Help the employee connect difficulty signals to specific support steps.',
    platformNote: 'This training module is for learning and reflection only. It does not replace site-specific safety protocols, supervisor guidance, or emergency procedures. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m3l3: {
    ...
    estimatedTime: '8–10 minutes',
    summary: 'Support strategies are skills or actions that help you manage difficult situations. This lesson helps you review what works, what does not, and how to build a practical support toolkit.',
    learningGoals: [
      'Understand different types of support strategies.',
      'Identify strategies that already help.',
      'Build a flexible support toolkit.',
    ...
    sections: [
      ...
      { heading: 'Make strategies easy to access', body: 'Keep support strategies visible and simple. Add them to your support plan or AutoSkill OS™ notes so you do not have to remember them during distress.' },
      { heading: 'Review with your supervisor', body: 'Your supervisor can help adjust support strategies and explore why some feel easier or harder.' }
    ],
    reflectionPrompt: 'Which support strategy has helped you even slightly?',
    ...
    supervisorNote: 'Review whether support strategies are accessible, safe, and realistic for the employee\'s context.',
    platformNote: 'This training module is for learning and reflection only. It does not replace site-specific safety protocols, supervisor guidance, or emergency procedures. For on-site emergencies, follow your site emergency procedure immediately.',
    completionLabel: 'I have strengthened my support toolkit'
  },
  ...
  m3l4: {
    ...
    sections: [
      ...
      { heading: 'Review recent check-ins', body: 'Look at readiness, confidence, stress, sleep, support strategy use, and support flags. Notice anything that changed or repeated.' },
      { heading: 'Choose key topics', body: 'You might discuss triggers, difficult moments, progress, questions, support strategies, medication concerns if relevant to your healthcare provider, relationship issues, work stress, or support needs.' },
  ...
  m3l5: {
    ...
    summary: 'A personal competency plan brings together what you have learned about your performance, triggers, support strategies, support needs, and goals. This lesson helps you create a practical plan you can review with your supervisor.',
    learningGoals: [
      'Bring together learning from the pathway.',
      'Identify strengths, triggers, and support strategies.',
      'Create realistic training progress goals.',
    ...
    learnerTask: 'Create a personal competency plan with five sections: strengths, triggers, warning signs, support strategies, and support contacts.',
    supervisorNote: 'Use the competency plan as a collaborative tool. Review for realism, safety, and employee ownership.',
    platformNote: 'This training module is for learning and reflection only. It does not replace site-specific safety protocols, supervisor guidance, or emergency procedures. For on-site emergencies, follow your site emergency procedure immediately.',
