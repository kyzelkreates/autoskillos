/* AutoSkill OS™ — Employee Learning PWA App
   AutoSkill OS™ Employee Learning PWA — employee-app logic
   File path: ap3x/patient-pwa/patient-app.js (preserved for deployment / service worker compatibility)
...
function tlEnqueueSync(eventType, data) {
  try {
    ...
    q.push({ id: Date.now() + '_' + Math.random().toString(36).slice(2), type: eventType, data, queued_at: new Date().toISOString(), status: 'pending', source: 'employee_pwa' });
...
const LESSON_CONTENT = {
  ...
  m1l1: {
    ...
    employeeExercise: 'Before your next shift, identify one aspect of your workstation setup you want to understand better. Write it down and ask your supervisor if you need clarification.',
  ...
  m1l2: {
    ...
    employeeExercise: 'Look at the lesson list for this module. Identify which lessons have checkpoint questions and which have safety acknowledgements.',
    safetyNote: 'AutoSkill OS™ supports training awareness and evidence capture. It does not replace workplace safety procedures, legal duties, qualified supervision, or employer responsibility. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m1l3: {
    ...
    employeeExercise: 'If you were explaining your workstation role to a new colleague, what would you say in three sentences? Write it down.',
    safetyNote: 'AutoSkill OS™ supports training awareness and evidence capture. It does not replace workplace safety procedures, legal duties, qualified supervision, or employer responsibility. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m1l4: {
    ...
    employeeExercise: 'Write a simple five-item readiness checklist for your workstation: PPE, tools, materials, area condition, and process step confirmation.',
    safetyNote: 'AutoSkill OS™ supports training awareness and evidence capture. It does not replace workplace safety procedures, legal duties, qualified supervision, or employer responsibility. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m1l5: {
    ...
    employeeExercise: 'Identify two tools you use at your workstation. For each, write: what it does, how to inspect it before use, and where it is stored when not in use.',
    safetyNote: 'AutoSkill OS™ supports training awareness and evidence capture. It does not replace workplace safety procedures, legal duties, qualified supervision, or employer responsibility. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m2l1: {
    ...
    employeeExercise: 'Write a brief defect report template for your workstation: what, where, when, and action taken.',
    safetyNote: 'AutoSkill OS™ supports training awareness and evidence capture. It does not replace workplace safety procedures, legal duties, qualified supervision, or employer responsibility. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m2l2: {
    ...
    employeeExercise: 'Write a sample handover note for your current or most recent workstation: completed items, pending issues, and safety concerns.',
    safetyNote: 'AutoSkill OS™ supports training awareness and evidence capture. It does not replace workplace safety procedures, legal duties, qualified supervision, or employer responsibility. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m2l3: {
    ...
    employeeExercise: 'Write a step-by-step description of how you would complete a process checkpoint at your workstation.',
    safetyNote: 'AutoSkill OS™ supports training awareness and evidence capture. It does not replace workplace safety procedures, legal duties, qualified supervision, or employer responsibility. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m2l4: {
    ...
    employeeExercise: 'Write a simple safety check list for your workstation covering at least five items: PPE, equipment, area condition, tool storage, and emergency access.',
    safetyNote: 'AutoSkill OS™ supports training awareness and evidence capture. It does not replace workplace safety procedures, legal duties, qualified supervision, or employer responsibility. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m2l5: {
    ...
    employeeExercise: 'List three things you would check or prepare before requesting supervisor sign-off on a module.',
    safetyNote: 'AutoSkill OS™ supports training awareness and evidence capture. It does not replace workplace safety procedures, legal duties, qualified supervision, or employer responsibility. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m3l1: {
    ...
    employeeExercise: 'Open the Progress tab. Write down: how many lessons are complete, how many safety acknowledgements are done, and what you think is your biggest knowledge gap right now.',
    safetyNote: 'AutoSkill OS™ supports training awareness and evidence capture. It does not replace workplace safety procedures, legal duties, qualified supervision, or employer responsibility. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m3l2: {
    ...
    employeeExercise: 'Write a list of three early warning signs that would tell you something may be wrong at your workstation. What would you do for each?',
    safetyNote: 'AutoSkill OS™ supports training awareness and evidence capture. It does not replace workplace safety procedures, legal duties, qualified supervision, or employer responsibility. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m3l3: {
    ...
    employeeExercise: 'Write a simple skill development plan for one of your core process skills: what you want to improve, how you will practise, and what feedback you will ask your supervisor for.',
    safetyNote: 'AutoSkill OS™ supports training awareness and evidence capture. It does not replace workplace safety procedures, legal duties, qualified supervision, or employer responsibility. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m3l4: {
    ...
    employeeExercise: 'Prepare a short brief for your next supervisor check-in: three completed milestones, one gap you have identified, and one question you want to ask.',
    safetyNote: 'AutoSkill OS™ supports training awareness and evidence capture. It does not replace workplace safety procedures, legal duties, qualified supervision, or employer responsibility. For on-site emergencies, follow your site emergency procedure immediately.',
  ...
  m3l5: {
    ...
    employeeExercise: 'Write a short personal commitment statement: what you will do differently after completing this pathway, and what you will ask for support with from your supervisor.',
...
// ── App State ─────────────────────────────────────────────────────
// Storage keys prefixed 'ap3x_patient_*' are preserved for backward compat
// (renaming would wipe existing employee progress). New keys use 'autoskill.*'.
...
function buildOnboarding() {
  ...
  <div class="ob-inner">
    ...
    <div class="ob-step" id="ob2">
      ...
      <div class="ob-field"><label class="ob-label">Full Name</label><input type="text" id="ob-name" class="ob-input" placeholder="e.g. Alex Johnson"/></div>
...
function buildPortal() {
  ...
  document.getElementById('portal-root').innerHTML = `
    ...
    <nav class="bottom-nav">
      ...
      <button class="nav-tab" id="tab-btn-coach" onclick="switchTab('coach')" aria-label="AI Learning Coach" style="display:none">
        <span style="font-size:20px">&#x1F916;</span>Coach</button>
    </nav>
    ...
    <div id="tab-coach" class="tab-page hidden"></div>
...
function renderAll() {
  ...
  renderProgress();
  updateHeader();
  updateAICoachTabVisibility(); // Run 14: show/hide coach tab based on settings
}
...
function renderHome() {
  ...
  document.getElementById('tab-home').innerHTML =
    ...
    '<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:4px">' + '<div style="font-size:11px;font-weight:700;color:var(--muted);text-transform:uppercase;letter-spacing:.06em">Quick Access</div>' + '<span style="font-size:10px;padding:2px 8px;border-radius:99px;font-weight:700;background:' + (demoOn?'rgba(201,168,76,.15)':'rgba(34,197,94,.12)') + ';color:' + (demoOn?'var(--gold)':'var(--green)') + ';border:1px solid ' + (demoOn?'rgba(201,168,76,.3)':'rgba(34,197,94,.25)') + '">' + (demoOn ? '\ud83c\udfad Demo' : '\ud83d\udfe2 Live') + '</span></div>' + '<div class="quick-grid">' +
      (function(){
        ...
        var bdr = pathRec ? 'border:2px solid var(--green)' : '';
        return '<button class="qa-btn" onclick="switchTab(\'pathway\')" aria-label="View Training Pathway" style="' + bdr + '">' +
    ...
    (function(){
      var pathRec = sGet('ap3x_pathway_completed', null);
      if (!pathRec) return '';
      var dateStr = pathRec.completedAt
    ...
    // ── Install card — only shown when not in standalone mode ───────────────
    (function() {
      var isStandalone = window.matchMedia && window.matchMedia('(display-mode: standalone)').matches;
      var isIOS = /iphone|ipad|ipod/i.test(navigator.userAgent);
      var isDismissed = sGet('ap3x_install_dismissed', false);
      if (isStandalone || isDismissed) return '';
      var hasPrompt = !!window._asInstallPrompt;
      return '<div id="as-home-install-card" style="background:rgba(201,168,76,.08);border:1.5px solid rgba(201,168,76,.35);border-radius:var(--r);padding:14px;margin-top:12px">' +
        '<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px">' +
          '<div style="font-size:13px;font-weight:800;color:var(--gold)">&#x1F4F2; Install AutoSkill OS&#x2122;</div>' +
          '<button onclick="sSet(\'ap3x_install_dismissed\',true);var c=document.getElementById(\'as-home-install-card\');if(c)c.remove();" ' +
            'style="background:transparent;border:none;color:var(--muted);font-size:16px;cursor:pointer;padding:0 4px" aria-label="Dismiss">&#x2715;</button>' +
        '</div>' +
        '<div style="font-size:12px;color:var(--muted);margin-bottom:10px;line-height:1.5">' +
          'Add AutoSkill OS&#x2122; to your home screen for the full offline training experience.' +
        '</div>' +
        (hasPrompt
          ? '<button onclick="window.asPromptInstall && window.asPromptInstall()" ' +
              'style="width:100%;padding:11px;background:var(--gold);color:#000;border:none;border-radius:var(--rs);font-size:14px;font-weight:800;cursor:pointer">' +
              '&#x2B07; Add to Home Screen' +
            '</button>'
          : (isIOS
              ? '<div style="font-size:12px;color:var(--text);line-height:1.7;background:var(--surface2);border-radius:var(--rs);padding:10px 12px">' +
                  '&#x1F4F1; On iPhone/iPad: tap <strong>&#x2B06; Share</strong> then select <strong>\"Add to Home Screen\"</strong>.' +
                '</div>'
              : '<div style="font-size:12px;color:var(--text);line-height:1.7;background:var(--surface2);border-radius:var(--rs);padding:10px 12px">' +
                  '&#x1F4F2; Open this page in your browser (Chrome or Edge) then tap <strong>&#x22EE; Menu &#x2192; Add to Home Screen</strong>.' +
                '</div>'
            )
        ) +
      '</div>';
  ...
  setTimeout(function(){
    if(window.asRefreshInstallUI)window.asRefreshInstallUI();
    // Also re-render home install card if prompt just became available
    var card = document.getElementById('as-home-install-card');
    if (card && window._asInstallPrompt) {
      var btn = card.querySelector('button[onclick*="asPromptInstall"]');
      if (!btn) {
        // Replace tip with install button
        var tipDiv = card.querySelector('div[style*="surface2"]');
        if (tipDiv) {
          var installBtn = document.createElement('button');
          installBtn.setAttribute('onclick', 'window.asPromptInstall && window.asPromptInstall()');
          installBtn.style.cssText = 'width:100%;padding:11px;background:var(--gold);color:#000;border:none;border-radius:8px;font-size:14px;font-weight:800;cursor:pointer';
          installBtn.textContent = '⬇ Add to Home Screen';
          card.replaceChild(installBtn, tipDiv);
        }
      }
    }
  },0);
  ...
  document.getElementById('tab-lessons').innerHTML = `
    ...
    ${(function() {
      ...
      return '<div style="background:rgba(34,197,94,.08);border:1.5px solid rgba(34,197,94,.35);border-radius:var(--r);padding:18px 16px;margin:12px 0;text-align:center">' +
        ...
        '<div style="font-size:13px;color:var(--text);margin-bottom:4px">New Starter Manufacturing Training Pathway</div>' +
...
function openLesson(id, xpVal) {
  ...
  panel.innerHTML =
    ...
    + '<div style="background:var(--surface);border-radius:var(--r);padding:14px;margin-bottom:14px;border:1px solid var(--border)"><div style="font-size:12px;font-weight:700;color:var(--gold);text-transform:uppercase;letter-spacing:.05em;margin-bottom:8px">\u270f\ufe0f Your Exercise</div><div style="font-size:14px;line-height:1.7;margin-bottom:10px">' + lc.employeeExercise + '</div>'
    + '<textarea id="ld-note-field" style="width:100%;background:var(--surface2);border:1.5px solid var(--border);border-radius:var(--rs);padding:10px 12px;font-size:13px;color:var(--text);font-family:inherit;resize:none;min-height:60px;outline:none" placeholder="Write your reflection or notes here\u2026" rows="3">' + savedNote + '</textarea>'
    + '<div style="margin-top:8px">'
    + '<button onclick="saveExerciseAnswer(\'' + id + '\')" style="width:100%;padding:11px 14px;background:var(--gold);color:#000;border:none;border-radius:var(--rs);font-size:13px;font-weight:700;cursor:pointer">💾 Save &amp; Send to Dashboard</button>'
    + '</div>'
    + '</div>'
...
// ── saveExerciseAnswer: save note + queue to dashboard ───────────────────────
function saveExerciseAnswer(id) {
  var field = document.getElementById('ld-note-field');
  if (!field) return;
  var noteText = field.value.trim();
  if (!noteText) { showToast('Please write your answer first.'); return; }
  sSet('tl_lesson_note_' + id, noteText);
  try {
    var item = {
      id: 'sq_reflect_' + id + '_' + Date.now(),
      type: 'reflection_submitted',
      entityType: 'lessonReflection',
      entityId: id,
      status: 'queued',
      priority: 'normal',
      isDemo: isPwaDemoMode ? isPwaDemoMode() : sGet('4p3x_demo_mode', true),
      data: {
        lessonId: id,
        noteText: noteText,
        lessonTitle: (LESSON_CONTENT[id] || {}).title || id,
        submittedAt: new Date().toISOString(),
        employeeId: profile && profile.userId ? profile.userId : 'anon'
      },
    ...
    var queue = dmGet(AP3X_SYNC_QUEUE_KEY, []);
    queue.push(item);
    dmSet(AP3X_SYNC_QUEUE_KEY, queue);
  } catch(e) {}
  showToast('\u2713 Answer saved — queued for supervisor review');
  var btn = field.parentNode && field.parentNode.querySelector('button');
  if (btn) { btn.textContent = '\u2713 Saved — queued for dashboard'; btn.style.background = 'var(--green)'; btn.disabled = true; }
}
...
function triggerPathwayCompletion() {
  ...
  if (!existing) {
    ...
    sSet('ap3x_pathway_completed', rec);
    tlEnqueueSync('pathway_completed', rec);
  }
  var panel = document.getElementById('lesson-detail-panel');
...
function showPathwayCompletionModal() {
  var old = document.getElementById('pathway-completion-modal');
  if (old) old.remove();
  var rec = sGet('ap3x_pathway_completed', {});
  var dateStr = rec.completedAt
    ? new Date(rec.completedAt).toLocaleDateString('en-GB', { day:'numeric', month:'long', year:'numeric' })
    : 'Today';
  ...
  overlay.innerHTML =
    '<div style="background:var(--surface);border:2px solid var(--gold);border-radius:16px;padding:28px 22px;max-width:400px;width:100%;text-align:center;box-shadow:0 8px 40px rgba(201,168,76,.25)">' +
      ...
      '<div style="background:var(--surface2);border:1px solid var(--border);border-radius:10px;padding:10px 14px;margin-bottom:18px;font-size:12px;color:var(--muted);line-height:1.6">' +
        'Skills Readiness: Training pathway complete. Supervisor sign-off required for full workplace competency confirmation.' +
      '</div>' +
...
// ════════════════════════════════════════════════════════════════════════════
// AutoSkill OS™ — Run 14: AI Learning Coach PWA Module
// Powered by 4P3X Intelligent AI™ — Created by Kyzel Kreates™
//
// TWO-LAYER CONTROL:
//   Layer 1 — Global/Admin:   AICoachEngine.getGlobalConfig().globalEnabled
//   Layer 2 — Employee/PWA:   AICoachEngine.getEmployeePref().aiLearningCoachEnabled
//
// Coach renders ONLY when BOTH layers are true.
// Turning it off via employee toggle: hides coach, never affects lessons/progress.
// ════════════════════════════════════════════════════════════════════════════

// ── R14.1: Tab visibility gate ────────────────────────────────────────────────
function updateAICoachTabVisibility() {
  var btn = document.getElementById('tab-btn-coach');
  if (!btn) return;
  var visible = (typeof AICoachEngine !== 'undefined') && AICoachEngine.isCoachVisible();
  btn.style.display = visible ? '' : 'none';
  // If currently on coach tab but coach was just disabled — redirect to home
  var coachPage = document.getElementById('tab-coach');
  if (!visible && coachPage && !coachPage.classList.contains('hidden')) {
    switchTab('home');
  }
}

// ── R14.2: Render the AI Coach tab ───────────────────────────────────────────
function renderAICoach() {
  var el = document.getElementById('tab-coach');
  if (!el) return;

  // Safety gate — never render if engine missing or both controls say off
  if (typeof AICoachEngine === 'undefined') {
    el.innerHTML = '<div style="padding:24px;text-align:center;color:var(--muted);font-size:13px">AI Coach engine not loaded.</div>';
    return;
  }

  var cfg     = AICoachEngine.getGlobalConfig();
  var pref    = AICoachEngine.getEmployeePref();
  var visible = cfg.globalEnabled && pref.aiLearningCoachEnabled;
  var ctx     = AICoachEngine.readContext();

  // If globally disabled — show nothing (tab should already be hidden, but safety belt)
  if (!cfg.globalEnabled) {
    el.innerHTML = '';
    return;
  }

  // If employee turned it off — show minimal re-enable area only
  if (!pref.aiLearningCoachEnabled) {
    el.innerHTML =
      '<div style="padding:32px 20px;text-align:center">' +
        '<div style="font-size:32px;margin-bottom:12px;opacity:.4">🤖</div>' +
        '<div style="font-size:14px;font-weight:700;color:var(--text);margin-bottom:8px">AI Learning Coach is off</div>' +
        '<div style="font-size:12px;color:var(--muted);line-height:1.6;margin-bottom:20px">Turn it back on in your PWA settings below, or tap the button to re-enable it now.</div>' +
        '<button onclick="aiCoachSetPref(true)" style="padding:10px 24px;background:var(--gold);color:#000;border:none;border-radius:var(--r);font-size:13px;font-weight:700;cursor:pointer;margin-bottom:24px">Turn AI Coach back on</button>' +
        '<div style="font-size:11px;color:var(--muted)">Powered by 4P3X Intelligent AI™ · AutoSkill OS™</div>' +
      '</div>';
    return;
  }

  // Mode badge
  var modeBadge = cfg.mode === 'live' && cfg.provider !== 'local-demo' && cfg.endpoint
    ? '<span style="font-size:10px;background:rgba(74,222,128,.12);color:#4ade80;border:1px solid rgba(74,222,128,.3);border-radius:4px;padding:2px 7px;font-weight:700;letter-spacing:.05em">LIVE AI</span>'
    : '<span style="font-size:10px;background:rgba(201,168,76,.12);color:var(--gold);border:1px solid rgba(201,168,76,.3);border-radius:4px;padding:2px 7px;font-weight:700;letter-spacing:.05em">DEMO MODE</span>';

  // Context chip
  var ctxChip = ctx.currentLessonTitle
    ? '<div style="font-size:11px;color:var(--muted);background:var(--surface2);border-radius:var(--rs);padding:6px 10px;margin-bottom:12px;line-height:1.5">📍 Current lesson: <strong style="color:var(--text)">' + ctx.currentLessonTitle + '</strong></div>'
    : '<div style="font-size:11px;color:var(--muted);background:var(--surface2);border-radius:var(--rs);padding:6px 10px;margin-bottom:12px">💡 Tip: Open a lesson first for personalised coaching.</div>';
  ...
  el.innerHTML =
    ...
    '<div style="padding:16px 16px 0">' +
      '<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:4px">' +
        '<div style="display:flex;align-items:center;gap:8px">' +
          ...
          '<div>' +
            '<div style="font-size:16px;font-weight:800;color:var(--text);letter-spacing:-.3px">AI Learning Coach</div>' +
            '<div style="font-size:11px;color:var(--muted)">Powered by 4P3X Intelligent AI™</div>' +
          '</div>' +
        '</div>' +
        '<div style="display:flex;align-items:center;gap:8px">' +
          modeBadge +
          // Employee ON/OFF toggle
          '<div onclick="aiCoachTogglePref()" style="cursor:pointer;display:flex;align-items:center;gap:6px;background:var(--surface2);border:1px solid var(--border);border-radius:20px;padding:4px 10px 4px 6px" title="Toggle AI Coach">' +
            '<div style="width:28px;height:16px;background:var(--gold);border-radius:8px;position:relative;flex-shrink:0">' +
              '<div style="width:12px;height:12px;background:#000;border-radius:50%;position:absolute;top:2px;right:2px;transition:right .2s"></div>' +
            '</div>' +
            '<span style="font-size:11px;color:var(--muted);font-weight:600">On</span>' +
          '</div>' +
        '</div>' +
      '</div>' +
    '</div>' +
    ...
    // ── Context chip ──
    '<div style="padding:0 16px">' + ctxChip + '</div>' +

    // ── Quick prompt buttons ──
    '<div style="padding:0 16px 12px">' +
      '<div style="font-size:11px;color:var(--muted);font-weight:600;margin-bottom:8px;text-transform:uppercase;letter-spacing:.06em">Quick help</div>' +
      '<div style="display:flex;flex-wrap:wrap;gap:6px">' +
        '<button class="coach-prompt-btn" onclick="aiCoachPrompt(\'explain\')">📖 Explain this lesson</button>' +
        '<button class="coach-prompt-btn" onclick="aiCoachPrompt(\'recap\')">📋 Quick recap</button>' +
        '<button class="coach-prompt-btn" onclick="aiCoachPrompt(\'motivate\')">💪 Motivate me</button>' +
        '<button class="coach-prompt-btn" onclick="aiCoachPrompt(\'revisit\')">🔄 What to revisit?</button>' +
        '<button class="coach-prompt-btn" onclick="aiCoachPrompt(\'stuck\')">🆘 I\'m stuck</button>' +
        '<button class="coach-prompt-btn" onclick="aiCoachPrompt(\'quiz\')">📝 Quiz me</button>' +
      '</div>' +
    '</div>' +

    // ── Chat response area ──
    '<div id="coach-response-area" style="margin:0 16px 12px;min-height:100px;max-height:320px;overflow-y:auto;background:var(--surface2);border:1px solid var(--border);border-radius:var(--r);padding:14px;font-size:13px;line-height:1.7;color:var(--text);white-space:pre-wrap">' +
      '<span style="color:var(--muted)">👋 Hello' + (ctx.employeeName && ctx.employeeName !== 'Trainee' ? ', ' + ctx.employeeName : '') + '! Tap a button above or type a question below to get started.</span>' +
    '</div>' +

    // ── Free text input ──
    '<div style="padding:0 16px 12px;display:flex;gap:8px">' +
      '<input id="coach-input" type="text" placeholder="Ask a question about your training…" ' +
        'style="flex:1;background:var(--surface2);border:1px solid var(--border);border-radius:var(--rs);padding:10px 12px;font-size:13px;color:var(--text);outline:none" ' +
        'onkeydown="if(event.key===\'Enter\')aiCoachSend()" />' +
      '<button onclick="aiCoachSend()" style="padding:10px 16px;background:var(--gold);color:#000;border:none;border-radius:var(--rs);font-size:13px;font-weight:700;cursor:pointer;flex-shrink:0">Ask</button>' +
    '</div>' +

    // ── Disclaimer ──
    '<div style="margin:0 16px 8px;font-size:11px;color:var(--muted);line-height:1.5;background:rgba(201,168,76,.05);border:1px solid rgba(201,168,76,.15);border-radius:var(--rs);padding:8px 10px">' +
      '⚠️ The AI Learning Coach is a support tool. Always follow official training material, workplace procedures, supervisor instructions, and company safety policies. It does not mark lessons complete or replace authorised training.' +
    '</div>' +

    // ── Settings section ──
    '<div style="margin:0 16px 24px;background:var(--surface2);border:1px solid var(--border);border-radius:var(--r);padding:14px">' +
      '<div style="font-size:12px;font-weight:700;color:var(--gold);text-transform:uppercase;letter-spacing:.05em;margin-bottom:10px">⚙️ AI Coach Settings</div>' +
      '<div style="display:flex;align-items:center;justify-content:space-between;margin-bottom:8px">' +
        '<div>' +
          '<div style="font-size:13px;font-weight:600;color:var(--text)">AI Learning Coach</div>' +
          '<div style="font-size:11px;color:var(--muted);line-height:1.4">Use this optional coach for lesson help, motivation, and revision support.</div>' +
        '</div>' +
        '<div onclick="aiCoachTogglePref()" style="cursor:pointer;display:flex;flex-direction:column;align-items:center;gap:3px">' +
          '<div id="coach-pref-toggle-wrap" style="width:40px;height:22px;background:var(--gold);border-radius:11px;position:relative;transition:background .2s">' +
            '<div style="width:16px;height:16px;background:#000;border-radius:50%;position:absolute;top:3px;right:3px;transition:right .2s"></div>' +
          '</div>' +
          '<span id="coach-pref-toggle-label" style="font-size:10px;color:var(--gold);font-weight:700">AI Coach: On</span>' +
        '</div>' +
      '</div>' +
...
// ── R14.3: Toggle employee preference (PWA-controlled, Layer 2) ───────────────
function aiCoachTogglePref() {
  if (typeof AICoachEngine === 'undefined') return;
  var current = AICoachEngine.getEmployeePref().aiLearningCoachEnabled;
  AICoachEngine.setEmployeePref(!current);
  updateAICoachTabVisibility();
  renderAICoach();
  // If coach was just disabled — move to home tab
  if (current) { switchTab('home'); }
}

// Employee explicitly turns coach on (re-enable button)
function aiCoachSetPref(enabled) {
  if (typeof AICoachEngine === 'undefined') return;
  AICoachEngine.setEmployeePref(enabled);
  updateAICoachTabVisibility();
  renderAICoach();
}

// ── R14.4: Quick prompt handler ───────────────────────────────────────────────
function aiCoachPrompt(promptType) {
  if (typeof AICoachEngine === 'undefined') return;
  var area = document.getElementById('coach-response-area');
  if (!area) return;
  area.innerHTML = '<span style="color:var(--muted);animation:blink 1s infinite">🤔 Thinking…</span>';
  AICoachEngine.addToHistory('user', '[' + promptType + ']');
  AICoachEngine.getCoachResponse(promptType, null, function(err, response, mode) {
    var text = err ? '⚠️ Something went wrong. Please try again.' : response;
    area.textContent = text;
    area.scrollTop = 0;
    AICoachEngine.addToHistory('coach', text);
  });
}

// ── R14.5: Free-text send ─────────────────────────────────────────────────────
function aiCoachSend() {
  if (typeof AICoachEngine === 'undefined') return;
  ...
  if (!text) return;
  input.value = '';
  area.innerHTML = '<span style="color:var(--muted)">🤔 Thinking…</span>';
  AICoachEngine.addToHistory('user', text);
  AICoachEngine.getCoachResponse('free', text, function(err, response) {
    var reply = err ? '⚠️ Something went wrong. Please try again.' : response;
    area.textContent = reply;
    area.scrollTop = 0;
    AICoachEngine.addToHistory('coach', reply);
  });
}

// ── R14.6: Home tab coach entry point ────────────────────────────────────────
// Adds a small "Need help with this lesson?" card to the Home tab
// Called after renderHome() — non-destructive append

function maybeInjectCoachHomeCard() {
  if (typeof AICoachEngine === 'undefined' || !AICoachEngine.isCoachVisible()) return;
  var homeEl = document.getElementById('tab-home');
  if (!homeEl) return;
  if (homeEl.querySelector('#coach-home-card')) return; // already injected

  var card = document.createElement('div');
  card.id = 'coach-home-card';
  card.style.cssText = 'margin:0 12px 16px;background:linear-gradient(135deg,rgba(201,168,76,.08),rgba(139,92,246,.08));border:1px solid rgba(201,168,76,.25);border-radius:var(--r);padding:14px;display:flex;align-items:center;gap:12px;cursor:pointer';
  card.onclick = function() { switchTab('coach'); };
  card.innerHTML =
    '<span style="font-size:28px;flex-shrink:0">🤖</span>' +
    '<div style="flex:1">' +
      '<div style="font-size:13px;font-weight:700;color:var(--gold);margin-bottom:2px">Need help with this lesson?</div>' +
      '<div style="font-size:12px;color:var(--muted);line-height:1.4">Ask the AI Learning Coach for a simple explanation, motivation, or revision help.</div>' +
    '</div>' +
    '<span style="font-size:18px;color:var(--muted)">›</span>';
  homeEl.appendChild(card);
}

// ── R14.7: CSS for coach tab (injected once into head) ────────────────────────
function injectCoachCSS() {
  if (document.getElementById('ai-coach-styles')) return;
  var style = document.createElement('style');
  style.id  = 'ai-coach-styles';
  style.textContent = [
    '.coach-prompt-btn{',
      'padding:7px 12px;',
...
// ── R14.8: Initialisation ─────────────────────────────────────────────────────
// Runs after boot — injects CSS, updates tab visibility, hooks renderHome

function r14_init() {
  injectCoachCSS();
  updateAICoachTabVisibility();

  // Hook renderHome to also inject the coach card (non-destructive)
  if (typeof window.renderHome === 'function') {
    var _origRenderHome = window.renderHome;
    window.renderHome = function() {
      _origRenderHome.apply(this, arguments);
      setTimeout(maybeInjectCoachHomeCard, 50);
    };
  }

  console.info('[AutoSkill OS™ R14] AI Coach module initialised. Visible:', typeof AICoachEngine !== 'undefined' && AICoachEngine.isCoachVisible());
}

if (document.readyState === 'loading') {
  document.addEventListener('DOMContentLoaded', r14_init);
} else {
  r14_init();
}

// ── End of Run 14: AI Learning Coach Module ────────────────────────────────────
// Disclaimer: The AI Learning Coach is a support tool only.
// It does not replace official training, workplace safety procedures,
// supervisor guidance, or company policy.
// AutoSkill OS™ · Powered by 4P3X Intelligent AI™ · Created by Kyzel Kreates™
// ════════════════════════════════════════════════════════════════════════════
